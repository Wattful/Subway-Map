...
const fourTrackExpressLayout = (line, accessibleLeft, accessibleRight) =>
    new LayoutBuilder([
        [
...
const fourTrackLocalLayout = (line, accessibleLeft, accessibleRight) =>
    new LayoutBuilder([
        [
...
const fourTrackLocalSeparatedByTypeLayout = (line, accessibleLeft, accessibleRight) =>
    new LayoutBuilder([
        [
            new Platform(PlatformType.SIDE, accessibleLeft, PlatformService.DOWN),
            new Track(line, TrackType.LOCAL, ArrowDirection.LEFT, true),
        ...
        [new Track(line, TrackType.EXPRESS, ArrowDirection.LEFT, false), new Track(line, TrackType.EXPRESS, ArrowDirection.RIGHT, false)],
    ]);

// Common two-track platform layouts
const twoTrackIslandLayout = (line, accessible) =>
    new LayoutBuilder([
        [
            new Track(line, TrackType.LOCAL, ArrowDirection.LEFT, true),
...
const twoTrackSideLayout = (line, accessibleLeft, accessibleRight) =>
    new LayoutBuilder([
        [
            new Platform(PlatformType.SIDE, accessibleLeft, PlatformService.DOWN),
            new Track(line, TrackType.LOCAL, ArrowDirection.LEFT, true),
...
const twoTrackSeparatedLayout = (line, accessibleLeft, accessibleRight) =>
    new LayoutBuilder([
        // TODO this has a few variations (address as it comes up)
        [new Track(line, TrackType.LOCAL, ArrowDirection.LEFT, true), new Platform(PlatformType.SIDE, accessibleLeft, PlatformService.UP)],
        [new Track(line, TrackType.LOCAL, ArrowDirection.RIGHT, true), new Platform(PlatformType.SIDE, accessibleRight, PlatformService.UP)],
    ]);

// Common three-track platform layouts
const threeTrackExpressLayout = (line, accessibleLeft, accessibleRight) =>
    new LayoutBuilder([
        [
            new Track(line, TrackType.LOCAL, ArrowDirection.LEFT, true),
...
const threeTrackLocalLayout = (line, accessibleLeft, accessibleRight) =>
    new LayoutBuilder([
        [
            new Platform(PlatformType.SIDE, accessibleLeft, PlatformService.DOWN),
            new Track(line, TrackType.LOCAL, ArrowDirection.LEFT, true),
...
const selfPointingPlatformSetObject = (name, disambiguator, type, opened, layout, position) => ({
    [gdn(name, disambiguator)]: new PlatformSet(name, disambiguator, type, opened, layout, position),
});
...
const selfPointingMultiTabStationObject = (name, disambiguator, platformSetsLayouts, boardings, odt) => ({
    [gdn(name, disambiguator)]: new Station(name, disambiguator, platformSetsLayouts, boardings, odt),
});
...
const STATIONS = {
    // QBL
    ...selfPointingStationObject(
        "Jamaica-179th Street",
        null,
        StructureType.UNDERGROUND,
        DateTime.fromObject({year: 1950, month: 12, day: 10}),
        fourTrackExpressLayout(Line.IND_QUEENS_BOULEVARD_LINE, true, true).get(),
        coordsForID(469),
        3944828,
        null,
    ),
    ...selfPointingStationObject(
        ...
        null,
        StructureType.UNDERGROUND,
        DateTime.fromObject({year: 1937, month: 4, day: 24}),
        fourTrackLocalLayout(Line.IND_QUEENS_BOULEVARD_LINE, false, false).get(),
        coordsForID(344),
        1627817,
        true,
    ),
    ...selfPointingStationObject(
        ...
        StructureType.UNDERGROUND,
        DateTime.fromObject({year: 1937, month: 4, day: 24}),
        fourTrackExpressLayout(Line.IND_QUEENS_BOULEVARD_LINE, false, false).get(),
        coordsForID(343),
        1584984,
        true,
    ),
    ...
    ...selfPointingStationObject(
        ...
        null,
        StructureType.UNDERGROUND,
        DateTime.fromObject({year: 1936, month: 12, day: 31}),
        fourTrackExpressLayout(Line.IND_QUEENS_BOULEVARD_LINE, true, true).get(),
        coordsForID(310),
        5016215,
        true,
    ...
    ...selfPointingStationObject(
        "Woodhaven Boulevard",
        Line.IND_QUEENS_BOULEVARD_LINE,
        StructureType.UNDERGROUND,
        DateTime.fromObject({year: 1936, month: 12, day: 31}),
        fourTrackLocalLayout(Line.IND_QUEENS_BOULEVARD_LINE, false, false).get(),
        coordsForID(388),
    ...
    ...selfPointingMultiTabStationObject(
        "Jackson Heights–Roosevelt Avenue/74th Street",
        null,
        {
            ...selfPointingPlatformSetObject(
                "74th Street-Broadway",
                null,
                StructureType.UNDERGROUND,
                DateTime.fromObject({year: 1917, month: 4, day: 21}),
                threeTrackLocalLayout(Line.IRT_FLUSHING_LINE, true, true).get(),
                coordsForID(386),
            ),
            ...selfPointingPlatformSetObject(
                ...
                null,
                StructureType.UNDERGROUND,
                DateTime.fromObject({year: 1933, month: 8, day: 19}),
                fourTrackExpressLayout(Line.IND_QUEENS_BOULEVARD_LINE, true, true).get(),
                coordsForID(200),
            ),
        },
    ...
    ...selfPointingStationObject(
        ...
        StructureType.UNDERGROUND,
        DateTime.fromObject({year: 1933, month: 8, day: 19}),
        fourTrackLocalSeparatedByTypeLayout(Line.IND_QUEENS_BOULEVARD_LINE, false, false).get(),
        coordsForID(396),
        1400392,
        false,
    ),
    ...selfPointingStationObject(
        ...
        StructureType.UNDERGROUND,
        DateTime.fromObject({year: 1933, month: 8, day: 19}),
        twoTrackSideLayout(Line.IND_QUEENS_BOULEVARD_LINE, false, false).get(),
        coordsForID(395),
        1662115,
        false,
    ),
    ...
    ...selfPointingMultiTabStationObject(
        ...
        null,
        {
            ...selfPointingPlatformSetObject(
                "Court Square",
                Line.IRT_FLUSHING_LINE,
                StructureType.UNDERGROUND,
                DateTime.fromObject({year: 1916, month: 11, day: 5}),
                twoTrackSideLayout(Line.IRT_FLUSHING_LINE, true, true).get(),
                coordsForID(262),
            ),
            ...selfPointingPlatformSetObject(
                "Court Square-23rd Street",
                null,
                StructureType.UNDERGROUND,
                DateTime.fromObject({year: 1939, month: 8, day: 28}),
                twoTrackSideLayout(Line.IND_QUEENS_BOULEVARD_LINE, true, false).get(),
                coordsForID(287),
            ),
            ...selfPointingPlatformSetObject(
                "Court Square",
                Line.IND_CROSSTOWN_LINE,
                StructureType.UNDERGROUND,
                DateTime.fromObject({year: 1933, month: 8, day: 19}),
                twoTrackIslandLayout(Line.IND_CROSSTOWN_LINE, true).get(),
                coordsForID(288),
            ),
        },
        5381184,
    ...
    ...selfPointingMultiTabStationObject(
        ...
        null,
        {
            ...selfPointingPlatformSetObject(
                ...
                null,
                StructureType.UNDERGROUND,
                DateTime.fromObject({year: 1918, month: 7, day: 17}),
                fourTrackLocalSeparatedByTypeLayout(Line.IRT_LEXINGTON_AVENUE_LINE, true, true).get(),
                coordsForID(277),
            ),
            ...selfPointingPlatformSetObject(
                ...
                StructureType.UNDERGROUND,
                DateTime.fromObject({year: 1933, month: 8, day: 19}),
                twoTrackIslandLayout(Line.IND_QUEENS_BOULEVARD_LINE, false).get(),
                coordsForID(265),
            ),
        },
        11339465,
    ...
    ...selfPointingStationObject(
        ...
        StructureType.UNDERGROUND,
        DateTime.fromObject({year: 1933, month: 8, day: 19}),
        twoTrackSeparatedLayout(Line.IND_QUEENS_BOULEVARD_LINE, false, false).get(),
        coordsForID(264),
        4733296,
        true,
    ),
    ...
    ...selfPointingStationObject(
        ...
        null,
        StructureType.UNDERGROUND,
        DateTime.fromObject({year: 1932, month: 9, day: 10}),
        [
            [
            ...
            [
                new Label({
                    label: Line.IND_QUEENS_BOULEVARD_LINE,
                    type: StructureType.UNDERGROUND,
                    opened: DateTime.fromObject({year: 1933, month: 8, day: 19}),
                }),
    ...
    ...selfPointingStationObject(
        ...
        null,
        StructureType.UNDERGROUND,
        DateTime.fromObject({year: 1988, month: 12, day: 11}),
        [
            [
    ...
    ...selfPointingStationObject(
        ...
        StructureType.UNDERGROUND,
        DateTime.fromObject({year: 1988, month: 12, day: 11}),
        twoTrackIslandLayout(Line.IND_ARCHER_AVENUE_LINE, true).get(),
        coordsForID(415),
        1053098,
        true,
    ),
    ...
    ...selfPointingStationObject(
        ...
        DateTime.fromObject({year: 1918, month: 7, day: 3}),
        threeTrackLocalLayout(Line.BMT_JAMAICA_LINE, false, false).override(0, 2, noTrackOrTrackbed).get(),
        coordsForID(353),
        464940,
        true,
    ),
    ...selfPointingStationObject(
        ...
        null,
        StructureType.ELEVATED,
        DateTime.fromObject({year: 1917, month: 5, day: 28}),
        threeTrackLocalLayout(Line.BMT_JAMAICA_LINE, false, false).get(),
        coordsForID(352),
        469638,
        true,
    ),
    ...
    ...selfPointingStationObject(
        "Woodhaven Boulevard",
        Line.BMT_JAMAICA_LINE,
        StructureType.ELEVATED,
        DateTime.fromObject({year: 1917, month: 5, day: 28}),
        threeTrackLocalLayout(Line.BMT_JAMAICA_LINE, true, true).override(0, 2, noTrackOrTrackbed).get(),
        coordsForID(351),
        561288,
        true,
    ),
    ...
    ...selfPointingStationObject(
        ...
        null,
        StructureType.ELEVATED,
        DateTime.fromObject({year: 1893, month: 5, day: 30}),
        threeTrackLocalLayout(Line.BMT_JAMAICA_LINE, false, false).override(0, 2, noTrackOrTrackbed).get(),
        coordsForID(383),
        272614,
        true,
    ...
    ...selfPointingStationObject(
        ...
        StructureType.ELEVATED,
        DateTime.fromObject({year: 1893, month: 5, day: 30}),
        twoTrackIslandLayout(Line.BMT_JAMAICA_LINE, false).get(),
        coordsForID(381),
        715796,
        true,
    ),
    ...
    ...selfPointingStationObject(
        ...
        null,
        StructureType.ELEVATED,
        DateTime.fromObject({year: 1885, month: 12, day: 3}),
        twoTrackIslandLayout(Line.BMT_JAMAICA_LINE, false).get(),
        coordsForID(361),
        529233,
        true,
    ...
    ...selfPointingStationObject(
        ...
        null,
        StructureType.ELEVATED,
        DateTime.fromObject({year: 1885, month: 9, day: 5}),
        twoTrackIslandLayout(Line.BMT_JAMAICA_LINE, false).get(),
        coordsForID(376),
        371707,
        true,
    ...
    ...selfPointingMultiTabStationObject(
        ...
        null,
        {
            ...selfPointingPlatformSetObject(
                ...
                Line.BMT_JAMAICA_LINE,
                StructureType.ELEVATED,
                DateTime.fromObject({year: 1885, month: 6, day: 14}),
                threeTrackExpressLayout(Line.BMT_JAMAICA_LINE, false, false).get(),
                coordsForID(374),
            ),
            ...selfPointingPlatformSetObject(
                "Broadway Junction",
                Line.BMT_CANARSIE_LINE,
                StructureType.ELEVATED,
                DateTime.fromObject({year: 1928, month: 7, day: 14}),
                [
                    [
            ...
            ...selfPointingPlatformSetObject(
                "Broadway Junction",
                Line.IND_FULTON_STREET_LINE,
                StructureType.ELEVATED,
                DateTime.fromObject({year: 1946, month: 12, day: 30}),
                fourTrackExpressLayout(Line.IND_FULTON_STREET_LINE, false, false).get(),
                coordsForID(136),
            ),
        },
        1808472,
    ...
    ...selfPointingStationObject(
        ...
        null,
        StructureType.ELEVATED,
        DateTime.fromObject({year: 1885, month: 7, day: 18}),
        threeTrackLocalLayout(Line.BMT_JAMAICA_LINE, false, false).get(),
        coordsForID(373),
        605650,
        true,
    ...
    ...selfPointingStationObject(
        ...
        null,
        StructureType.ELEVATED,
        DateTime.fromObject({year: 1885, month: 8, day: 19}),
        threeTrackLocalLayout(Line.BMT_JAMAICA_LINE, false, false).get(),
        coordsForID(375),
        1221794,
        true,
    ...
    ...selfPointingStationObject(
        ...
        null,
        StructureType.ELEVATED,
        DateTime.fromObject({year: 1885, month: 5, day: 13}),
        threeTrackLocalLayout(Line.BMT_JAMAICA_LINE, false, false).get(),
        coordsForID(20),
        1466874,
        true,
    ...
    ...selfPointingStationObject(
        ...
        null,
        StructureType.ELEVATED,
        DateTime.fromObject({year: 1888, month: 6, day: 25}),
        threeTrackLocalLayout(Line.BMT_JAMAICA_LINE, false, false).get(),
        coordsForID(19),
        1310254,
        true,
    ...
    ...selfPointingStationObject(
        ...
        StructureType.ELEVATED,
        DateTime.fromObject({year: 1888, month: 6, day: 25}),
        threeTrackExpressLayout(Line.BMT_JAMAICA_LINE, false, false)
            .override(0, 0, {summary: "Westbound Local"})
            .override(0, 4, {summary: "Eastbound Local"})
            .get(),
        coordsForID(122),
        2788090,
        true,
    ...
    ...selfPointingStationObject(
        ...
        StructureType.ELEVATED,
        DateTime.fromObject({year: 1888, month: 6, day: 25}),
        threeTrackLocalLayout(Line.BMT_JAMAICA_LINE, true, true)
            .override(0, 1, {summary: "Westbound Local"})
            .override(0, 3, {summary: "Eastbound Local"})
            .get(),
        coordsForID(121),
        1658300,
        true,
    ...
    ...selfPointingStationObject(
        ...
        StructureType.ELEVATED,
        DateTime.fromObject({year: 1888, month: 6, day: 25}),
        threeTrackLocalLayout(Line.BMT_JAMAICA_LINE, false, false)
            .override(0, 1, {summary: "Westbound Local"})
            .override(0, 3, {summary: "Eastbound Local"})
            .get(),
        coordsForID(284),
    ...
    ...selfPointingMultiTabStationObject(
        ...
        null,
        {
            ...selfPointingPlatformSetObject(
                ...
                null,
                StructureType.UNDERGROUND,
                DateTime.fromObject({year: 1908, month: 9, day: 16}),
                [
                    [
            ...
            ...selfPointingPlatformSetObject(
                ...
                null,
                StructureType.UNDERGROUND,
                DateTime.fromObject({year: 1936, month: 1, day: 1}),
                twoTrackSideLayout(Line.IND_SIXTH_AVENUE_LINE, false, false).get(),
                coordsForID(119),
            ),
        },
        7079160,
    ...
    ...selfPointingStationObject(
        ...
        null,
        StructureType.UNDERGROUND,
        DateTime.fromObject({year: 1913, month: 8, day: 4}),
        fourTrackExpressLayout(Line.BMT_NASSAU_STREET_LINE, false, null)
            ...
            .override(0, 5, {type: null, direction: null, stops: null, description: "Former Northbound"})
            .get(),
        coordsForID(190),
        879248,
        true,
    ...
    ...selfPointingMultiTabStationObject(
        ...
        null,
        {
            ...selfPointingPlatformSetObject(
                "Canal Street",
                Line.IRT_LEXINGTON_AVENUE_LINE,
                StructureType.UNDERGROUND,
                DateTime.fromObject({year: 1904, month: 10, day: 27}),
                fourTrackLocalLayout(Line.IRT_LEXINGTON_AVENUE_LINE, true, true).get(),
                coordsForID(107),
            ),
            ...selfPointingPlatformSetObject(
                "Canal Street",
                Line.BMT_NASSAU_STREET_LINE,
                StructureType.UNDERGROUND,
                DateTime.fromObject({year: 1913, month: 8, day: 4}),
                fourTrackExpressLayout(Line.BMT_NASSAU_STREET_LINE, null, false)
                    .override(0, 2, {type: TrackType.LOCAL, direction: ArrowDirection.RIGHT})
                    .override(0, 3, {type: null, direction: null, stops: null, description: "Former Northbound", ...trackbed})
                    .override(0, 4, {service: PlatformService.NONE})
                    .override(0, 5, {type: null, direction: null, stops: null, description: "Former Northbound"})
                    .get(),
                coordsForID(169),
            ), // TODO better way to mark tracks as unused?
            ...selfPointingPlatformSetObject(
                "Canal Street",
                `${Line.BMT_BROADWAY_LINE} Lower Platforms`,
                StructureType.UNDERGROUND,
                DateTime.fromObject({year: 1917, month: 9, day: 4}),
                twoTrackSideLayout(Line.BMT_BROADWAY_LINE, false, false).get(),
                coordsForID(191),
            ),
            ...selfPointingPlatformSetObject(
                "Canal Street",
                `${Line.BMT_BROADWAY_LINE} Upper Platforms`,
                StructureType.UNDERGROUND,
                DateTime.fromObject({year: 1918, month: 1, day: 5}),
                fourTrackLocalLayout(Line.BMT_BROADWAY_LINE, false, false)
                    .override(0, 2, {description: "Center Track", trackDescription: "City Hall Layup"})
                    .override(0, 3, {description: "Center Track", trackDescription: "City Hall Layup"})
                    .get(),
                coordsForID(171),
            ),
        },
    ...
    ...selfPointingMultiTabStationObject(
        ...
        null,
        {
            ...selfPointingPlatformSetObject(
                ...
                StructureType.UNDERGROUND,
                DateTime.fromObject({year: 1904, month: 10, day: 27}),
                fourTrackExpressLayout(Line.IRT_LEXINGTON_AVENUE_LINE, true, true).get(),
                coordsForID(134),
            ),
            ...selfPointingPlatformSetObject(
                "Chambers Street",
    ...
    ...selfPointingMultiTabStationObject(
        ...
        null,
        {
            ...selfPointingPlatformSetObject(
                ...
                Line.IRT_LEXINGTON_AVENUE_LINE,
                StructureType.UNDERGROUND,
                DateTime.fromObject({year: 1905, month: 1, day: 16}),
                twoTrackSideLayout(Line.IRT_LEXINGTON_AVENUE_LINE, true, true).get(),
                coordsForID(181),
            ),
            ...selfPointingPlatformSetObject(
                "Fulton Street",
                Line.IRT_BROADWAY_SEVENTH_AVENUE_LINE,
                StructureType.UNDERGROUND,
                DateTime.fromObject({year: 1918, month: 7, day: 1}),
                twoTrackIslandLayout(Line.IRT_BROADWAY_SEVENTH_AVENUE_LINE, true).get(),
                coordsForID(156),
            ),
            ...selfPointingPlatformSetObject(
                "Fulton Street",
                Line.BMT_NASSAU_STREET_LINE,
                StructureType.UNDERGROUND,
                DateTime.fromObject({year: 1931, month: 5, day: 29}),
                twoTrackSeparatedLayout(Line.BMT_NASSAU_STREET_LINE, true, true).get(),
                coordsForID(167),
            ),
            ...selfPointingPlatformSetObject(
                "Fulton Street",
                Line.IND_EIGHTH_AVENUE_LINE,
                StructureType.UNDERGROUND,
                DateTime.fromObject({year: 1933, month: 2, day: 1}),
                twoTrackIslandLayout(Line.IND_EIGHTH_AVENUE_LINE, true).get(),
                coordsForID(109),
            ),
        },
        19221396,
    ...
    ...selfPointingStationObject(
        ...
        StructureType.UNDERGROUND,
        DateTime.fromObject({year: 1931, month: 5, day: 29}),
        twoTrackSideLayout(Line.BMT_NASSAU_STREET_LINE, false, false).get(),
        coordsForID(182),
        1289698,
        null,
    ),
    ...
    ...selfPointingStationObject(
        ...
        null,
        StructureType.ELEVATED,
        DateTime.fromObject({year: 1889, month: 7, day: 20}),
        threeTrackLocalLayout(Line.BMT_MYRTLE_AVENUE_LINE, false, false)
            .override(0, 2, {summary: "Center Track", ...noTrackOrTrackbed})
            .get(),
        coordsForID(21),
        886352,
        true,
    ...
    ...selfPointingStationObject(
        ...
        null,
        StructureType.ELEVATED,
        DateTime.fromObject({year: 1889, month: 8, day: 15}),
        threeTrackLocalLayout(Line.BMT_MYRTLE_AVENUE_LINE, false, false)
            .override(0, 2, {summary: "Center Track", ...noTrackOrTrackbed})
            .get(),
        coordsForID(22),
    ...
    ...selfPointingMultiTabStationObject(
        ...
        null,
        {
            ...selfPointingPlatformSetObject(
                "Myrtle-Wyckoff Avenues",
                Line.BMT_MYRTLE_AVENUE_LINE,
                StructureType.ELEVATED,
                DateTime.fromObject({year: 1889, month: 7, day: 20}),
                twoTrackIslandLayout(Line.BMT_MYRTLE_AVENUE_LINE, true).get(),
                coordsForID(389),
            ),
            ...selfPointingPlatformSetObject(
                "Myrtle-Wyckoff Avenues",
                ...
                StructureType.UNDERGROUND,
                DateTime.fromObject({year: 1928, month: 7, day: 14}),
                twoTrackIslandLayout(Line.BMT_CANARSIE_LINE, true).get(),
                coordsForID(491),
            ),
        },
        5230944,
    ...
    ...selfPointingStationObject(
        ...
        null,
        StructureType.ELEVATED,
        DateTime.fromObject({year: 1915, month: 2, day: 22}),
        twoTrackIslandLayout(Line.BMT_MYRTLE_AVENUE_LINE, false).get(),
        coordsForID(390),
        655571,
        true,
    ),
    ...
    ...selfPointingStationObject(
        ...
        DateTime.fromObject({year: 1915, month: 8, day: 9}),
        twoTrackIslandLayout(Line.BMT_MYRTLE_AVENUE_LINE, true).get(),
        coordsForID(178),
        1751180,
        true,
    ...
    ...selfPointingStationObject(
        ...
        null,
        StructureType.UNDERGROUND,
        DateTime.fromObject({year: 1989, month: 10, day: 29}),
        twoTrackSideLayout(Line.IND_63RD_STREET_LINE, true, true).get(),
        coordsForID(93),
        886352,
        true,
    ),
    ...
    ...selfPointingMultiTabStationObject(
        ...
        null,
        {
            ...selfPointingPlatformSetObject(
                ...
                StructureType.UNDERGROUND,
                DateTime.fromObject({year: 1936, month: 1, day: 1}),
                fourTrackExpressLayout(Line.IND_SIXTH_AVENUE_LINE, true, true).get(),
                coordsForID(189),
            ),
            ...selfPointingPlatformSetObject(
                "Bleecker Street",
    ...
    ...selfPointingMultiTabStationObject(
        ...
        null,
        {
            ...selfPointingPlatformSetObject(
                "14th Street",
                Line.IND_SIXTH_AVENUE_LINE,
                StructureType.UNDERGROUND,
                DateTime.fromObject({year: 1940, month: 12, day: 15}),
                [
                    [
                        new Track(Line.IND_SIXTH_AVENUE_LINE, TrackType.LOCAL, ArrowDirection.LEFT, true),
            ...
            ...selfPointingPlatformSetObject(
                ...
                null,
                StructureType.UNDERGROUND,
                DateTime.fromObject({year: 1924, month: 9, day: 24}),
                twoTrackIslandLayout(Line.BMT_CANARSIE_LINE, true).get(),
                coordsForID(205),
            ),
            ...selfPointingPlatformSetObject(
                ...
                StructureType.UNDERGROUND,
                DateTime.fromObject({year: 1918, month: 7, day: 1}),
                fourTrackExpressLayout(Line.IRT_BROADWAY_SEVENTH_AVENUE_LINE, true).get(),
                coordsForID(201),
            ),
        },
        10463838,
    ...
    ...selfPointingMultiTabStationObject(
        ...
        null,
        {
            ...selfPointingPlatformSetObject(
                "34th Street-Herald Square",
                Line.BMT_BROADWAY_LINE,
                StructureType.UNDERGROUND,
                DateTime.fromObject({year: 1918, month: 1, day: 5}),
                fourTrackExpressLayout(Line.BMT_BROADWAY_LINE, true, true).get(),
                coordsForID(267),
            ),
            ...selfPointingPlatformSetObject(
                "34th Street-Herald Square",
    ...
    ...selfPointingMultiTabStationObject(
        ...
        null,
        {
            ...selfPointingPlatformSetObject(
                ...
                StructureType.UNDERGROUND,
                DateTime.fromObject({year: 1940, month: 12, day: 15}),
                fourTrackExpressLayout(Line.IND_SIXTH_AVENUE_LINE, false, false).get(),
                coordsForID(275),
            ),
            ...selfPointingPlatformSetObject(
                "Fifth Avenue",
                null,
                StructureType.UNDERGROUND,
                DateTime.fromObject({year: 1926, month: 3, day: 22}),
                twoTrackIslandLayout(Line.IRT_FLUSHING_LINE, false).get(),
                coordsForID(274),
            ),
        },
        gdn("Times Square-42nd Street"),
        true,
    ),
    ...selfPointingStationObject(
    ...
    ...selfPointingStationObject(
        ...
        null,
        StructureType.UNDERGROUND,
        DateTime.fromObject({year: 1968, month: 7, day: 1}),
        twoTrackIslandLayout(Line.IND_SIXTH_AVENUE_LINE, true).get(),
        coordsForID(97),
        3002045,
        true,
    ),
...
const SERVICE_SEGMENTS = {
    ...
    ...selfPointingServiceSegmentObject(
        "QB1",
        [gdn("Jamaica-179th Street"), gdn("169th Street"), gdn("Parsons Boulevard"), gdn("Sutphin Boulevard")],
    ...
    ...selfPointingServiceSegmentObject(
        "QB4",
        [
            gdn("Forest Hills-71st Avenue"),
            gdn("67th Avenue"),
            gdn("63rd Drive-Rego Park"),
            gdn("Woodhaven Boulevard", Line.IND_QUEENS_BOULEVARD_LINE),
            gdn("Grand Avenue-Newtown"),
            gdn("Elmhurst Avenue"),
        ],
        ArrowDirection.RIGHT,
    ),
    ...
    ...selfPointingServiceSegmentObject(
        "QB11",
        [gdn("Court Square-23rd Street"), gdn("Lexington Avenue-53rd Street"), gdn("Fifth Avenue-53rd Street")],
        ArrowDirection.RIGHT,
    ),
    ...
    ...selfPointingServiceSegmentObject(
        "AA1",
        [gdn("Jamaica Center-Parsons/Archer"), gdn("Sutphin Boulevard-Archer Avenue-JFK Airport")],
        ArrowDirection.RIGHT,
    ),
    ...
    ...selfPointingServiceSegmentObject(
        ...
        [
            ...
            gdn("111th Street"),
            gdn("104th Street"),
            gdn("Woodhaven Boulevard", Line.BMT_JAMAICA_LINE),
            gdn("85th Street–Forest Parkway"),
            gdn("75th Street–Elderts Lane"),
            gdn("Cypress Hills"),
            gdn("Crescent Street"),
            gdn("Norwood Avenue"),
            gdn("Cleveland Street"),
            gdn("Van Siclen Avenue"),
            gdn("Alabama Avenue"),
        ],
        ArrowDirection.RIGHT,
    ),
    ...
    ...selfPointingServiceSegmentObject(
        "J3",
        [gdn("Chauncey Street"), gdn("Halsey Street"), gdn("Gates Avenue"), gdn("Kosciuszko Street")],
        ArrowDirection.RIGHT,
    ),
    ...
    ...selfPointingServiceSegmentObject(
        "MA1",
        [
            gdn("Middle Village-Metropolitan Avenue"),
            gdn("Fresh Pond Road"),
            gdn("Forest Avenue"),
            gdn("Seneca Avenue"),
            gdn("Myrtle-Wyckoff Avenues", Line.BMT_MYRTLE_AVENUE_LINE),
            gdn("Knickerbocker Avenue"),
            gdn("Central Avenue"),
        ],
        ArrowDirection.LEFT,
    ),
    ...
    ...selfPointingServiceSegmentObject(
        ...
        [
            gdn("Bowery"),
            gdn("Canal Street", Line.BMT_NASSAU_STREET_LINE),
            gdn("Chambers Street"),
            gdn("Fulton Street", Line.BMT_NASSAU_STREET_LINE),
            gdn("Broad Street"),
        ],
        ArrowDirection.RIGHT,
    ),
    ...
    ...selfPointingServiceSegmentObject(
        "6A1",
        [
            gdn("47th-50th Streets-Rockefeller Center"),
            gdn("42nd Street-Bryant Park"),
            gdn("34th Street-Herald Square", Line.IND_SIXTH_AVENUE_LINE),
            gdn("23rd Street", Line.IND_SIXTH_AVENUE_LINE),
            gdn("14th Street", Line.IND_SIXTH_AVENUE_LINE),
        ],
        ArrowDirection.RIGHT,
    ),
...
const segmentsWithLabel = (segments, type, line, northDirection = null, disambiguators = {}) =>
    segments.map((s) => new SegmentServiceLabel(s, type, line, northDirection, disambiguators));
...
const SERVICES = {
    [Service.B]: [
        new ServiceInformation(Service.B, "Sixth Avenue Express", [
            ...
            new ServicePattern(
                "Weekdays 5 - 9 AM and 4 - 7 PM, every other trip 9 AM - 4 PM",
                [
                ...
                null,
                null,
                new ServiceTime({[ServiceTimeComponent.RUSH_HOURS]: ServiceTimeType.YES, [ServiceTimeComponent.MIDDAYS]: ServiceTimeType.YES}),
            ),

            // Terminates at 145 St
            new ServicePattern(
                "Weekdays every other trip 9 AM - 4 PM",
                [
                    ...segmentsWithLabel(["QB6A", "6AQBW"], TrackType.LOCAL, Line.IND_SIXTH_AVENUE_LINE, ArrowDirection.LEFT),
                    ...segmentsWithLabel(["6A1", "6A8A", "6A2"], TrackType.EXPRESS, Line.IND_SIXTH_AVENUE_LINE),
                ],
                ...
                null,
                null,
                new ServiceTime({[ServiceTimeComponent.MIDDAYS]: ServiceTimeType.YES, [ServiceTimeComponent.EVENINGS]: ServiceTimeType.YES}),
            ),

            // Select - terminates at Kingsbridge Road and skips 182-183rd st
            new ServicePattern(
                "Three northbound AM rush trips",
                [
                    ...segmentsWithLabel(["QB6A", "6AQBW"], TrackType.LOCAL, Line.IND_SIXTH_AVENUE_LINE, ArrowDirection.LEFT),
                    ...segmentsWithLabel(["6A1", "6A8A", "6A2"], TrackType.EXPRESS, Line.IND_SIXTH_AVENUE_LINE),
                ],
                ...
                null,
                null,
                new ServiceTime({[ServiceTimeComponent.AM_RUSH]: ServiceTimeType.SELECT}),
                null,
            ),
        ]),
    ],
    ...
    [Service.D]: [
        new ServiceInformation(Service.D, "Sixth Avenue Express", [
            ...
            new ServicePattern(
                "Weekdays 6 AM - 10 PM except rush hours in the peak direction, Weekends 5 AM - 9 PM",
                [
                    ...segmentsWithLabel(["QB6A", "6AQBW"], TrackType.LOCAL, Line.IND_SIXTH_AVENUE_LINE, ArrowDirection.LEFT),
                    ...segmentsWithLabel(["6A1", "6A8A", "6A2"], TrackType.EXPRESS, Line.IND_SIXTH_AVENUE_LINE),
                ],
                ...
                null,
                new ServiceTime({
                    [ServiceTimeComponent.WEEKDAYS]: ServiceTimeType.YES,
                    [ServiceTimeComponent.WEEKENDS]: ServiceTimeType.YES,
                    [ServiceTimeComponent.PM_RUSH]: ServiceTimeType.NO,
                }),
                new ServiceTime({
                    [ServiceTimeComponent.WEEKDAYS]: ServiceTimeType.YES,
                    [ServiceTimeComponent.WEEKENDS]: ServiceTimeType.YES,
                    [ServiceTimeComponent.AM_RUSH]: ServiceTimeType.NO,
                }),
            ),

            // Express Bronx, Express Brooklyn
            new ServicePattern(
                "Southbound weekday trips 6 - 9 AM, northbound weekday trips 4 - 7 PM",
                [
                    ...segmentsWithLabel(["QB6A", "6AQBW"], TrackType.LOCAL, Line.IND_SIXTH_AVENUE_LINE, ArrowDirection.LEFT),
                    ...segmentsWithLabel(["6A1", "6A8A", "6A2"], TrackType.EXPRESS, Line.IND_SIXTH_AVENUE_LINE),
                ],
                ...
                null,
                null,
                new ServiceTime({[ServiceTimeComponent.PM_RUSH]: ServiceTimeType.YES}),
                new ServiceTime({[ServiceTimeComponent.AM_RUSH]: ServiceTimeType.YES}),
            ),
            ...
            new ServicePattern(
                "Four southbound PM rush and evening trips",
                [
                    ...segmentsWithLabel(["QB6A", "6AQBW"], TrackType.LOCAL, Line.IND_SIXTH_AVENUE_LINE, ArrowDirection.LEFT),
                    ...segmentsWithLabel(["6A1", "6A8A", "6A2"], TrackType.EXPRESS, Line.IND_SIXTH_AVENUE_LINE),
                ],
                ...
                null,
                null,
                new ServiceTime({[ServiceTimeComponent.EVENINGS]: ServiceTimeType.SELECT}),
            ),
        ]),
    ],
        ...
        new ServiceInformation(Service.E, "Eighth Avenue Local", [
            ...
            new ServicePattern(
                ...
                [
                    ...
                    ...segmentsWithLabel(
                        ["QB2", "QB3", "QB4", "QB5", "QB6E", "QB7", "QBAS1", "QBAS2", "QBAS3", "QB8", "QB9", "QB10"],
                        TrackType.EXPRESS,
                        Line.IND_QUEENS_BOULEVARD_LINE,
                    ),
            ...
            new ServicePattern(
                "Weekends all day, Weekdays 6 - 7 AM and 7 - 9:30 PM",
                [
                    ...segmentsWithLabel(["AA1", "AA2"], TrackType.LOCAL, Line.IND_ARCHER_AVENUE_LINE),
                    ...segmentsWithLabel(["QB2"], TrackType.LOCAL, Line.IND_QUEENS_BOULEVARD_LINE),
                    ...segmentsWithLabel(
                        ["QB3", "QB4", "QB5", "QB6E", "QB7", "QBAS1", "QBAS2", "QBAS3", "QB8", "QB9", "QB10"],
                        TrackType.EXPRESS,
                        Line.IND_QUEENS_BOULEVARD_LINE,
                    ),
                    ...segmentsWithLabel(["QB11", "QB12", "QB6A", "QB13"], TrackType.LOCAL, Line.IND_QUEENS_BOULEVARD_LINE, ArrowDirection.RIGHT),
                ...
                null,
                new ServiceTime({
                    [ServiceTimeComponent.EARLY_MORNINGS]: ServiceTimeType.YES,
                    [ServiceTimeComponent.EARLY_EVENINGS]: ServiceTimeType.YES,
                    [ServiceTimeComponent.WEEKENDS]: ServiceTimeType.YES,
                }),
            ),
            // Full local
            new ServicePattern(
                "Northbound trips 10 PM - 5 AM (6 AM Weekends)",
                [
                    ...segmentsWithLabel(["AA1", "AA2"], TrackType.LOCAL, Line.IND_ARCHER_AVENUE_LINE),
                ...
                {},
                null,
                new ServiceTime({[ServiceTimeComponent.LATE_EVENINGS]: ServiceTimeType.YES, [ServiceTimeComponent.LATE_NIGHTS]: ServiceTimeType.YES}),
                null,
            ),
            new ServicePattern(
                "Southbound trips 10 PM - 5 AM (6 AM Weekends)",
                [
                    ...segmentsWithLabel(["AA1", "AA2"], TrackType.LOCAL, Line.IND_ARCHER_AVENUE_LINE),
                    ...segmentsWithLabel(
                        ["QB2", "QB3", "QB4", "QB5", "QB6L", "QB7", "QBAS1", "QBAS2", "QBAS3", "QB8"],
                        TrackType.LOCAL,
                        Line.IND_QUEENS_BOULEVARD_LINE,
                    ),
            ...
            new ServicePattern(
                "Queens-bound trips Saturdays 6:30 - 7:30 AM and Sundays 6:30 - 8:30 AM",
                [
                    ...segmentsWithLabel(["AA1", "AA2"], TrackType.LOCAL, Line.IND_ARCHER_AVENUE_LINE),
                    ...segmentsWithLabel(["QB2", "QB3", "QB4"], TrackType.LOCAL, Line.IND_QUEENS_BOULEVARD_LINE),
                    ...segmentsWithLabel(
                        ["QB5", "QB6E", "QB7", "QBAS1", "QBAS2", "QBAS3", "QB8", "QB9", "QB10"],
                        TrackType.EXPRESS,
                        Line.IND_QUEENS_BOULEVARD_LINE,
                    ),
                    ...segmentsWithLabel(["QB11", "QB12", "QB6A", "QB13"], TrackType.LOCAL, Line.IND_QUEENS_BOULEVARD_LINE, ArrowDirection.RIGHT),
                ...
                {},
                null,
                new ServiceTime({[ServiceTimeComponent.WEEKENDS]: ServiceTimeType.SELECT}),
                null,
            ),
        ]),
    ],
    ...
    [Service.F]: [
        new ServiceInformation(Service.F, "Queens Boulevard Express/Sixth Avenue Local", [
            ...
            new ServicePattern(
                ...
                null,
                new ServiceTime({[ServiceTimeComponent.WEEKDAYS_EXCEPT_LATE_EVENINGS]: ServiceTimeType.YES}),
            ),

            // Evenings and late nights - local via 63rd
            new ServicePattern(
                "Queens-bound trips 9 PM - 5 AM, Brooklyn-bound trips 11 PM - 5 AM",
                [
            ...
            new ServicePattern(
                "Saturdays 6 AM - 9 PM, Sundays 7 AM - 9 PM, Brooklyn-bound trips 9 - 11 PM",
                [
                    ...segmentsWithLabel(["QB1", "QB2"], TrackType.LOCAL, Line.IND_QUEENS_BOULEVARD_LINE),
                ...
                null,
                new ServiceTime({[ServiceTimeComponent.WEEKENDS]: ServiceTimeType.YES}),
            ...
            new ServicePattern(
                "Seven Queens-bound AM rush trips",
                [
                    ...segmentsWithLabel(["QB1", "QB2"], TrackType.LOCAL, Line.IND_QUEENS_BOULEVARD_LINE),
                    ...segmentsWithLabel(
                        ["QB3", "QB4", "QB5", "QB6E", "QB7", "QBAS1", "QBAS2", "QBAS3", "QB8", "QB9", "QB10"],
            ...
            new ServicePattern(
                ...
                null,
                new ServiceTime({[ServiceTimeComponent.WEEKDAYS]: ServiceTimeType.SELECT}),
            ),

            // One AM rush trip each direction - Church Avenue - Jamaica express via 53rd
            new ServicePattern(
                "One AM rush trip each direction",
                [
                    ...segmentsWithLabel(["QB1", "QB2"], TrackType.LOCAL, Line.IND_QUEENS_BOULEVARD_LINE),
                    ...segmentsWithLabel(
                        ["QB3", "QB4", "QB5", "QB6E", "QB7", "QBAS1", "QBAS2", "QBAS3", "QB8", "QB9", "QB10"],
        ...
        new ServiceInformation(Service.Fd, "Queens Boulevard Express/Sixth Avenue Local", [
            new ServicePattern(
                "Rush hours, two trains in each direction",
                [
                    ...segmentsWithLabel(["QB1", "QB2"], TrackType.LOCAL, Line.IND_QUEENS_BOULEVARD_LINE),
                    ...segmentsWithLabel(
                        ["QB3", "QB4", "QB5", "QB6E", "QB7", "QBAS1", "QBAS2", "QBAS3", "QB8", "QB9", "QB10"],
                ...
                null,
                new ServiceTime({[ServiceTimeComponent.AM_RUSH]: ServiceTimeType.SELECT}),
                new ServiceTime({[ServiceTimeComponent.PM_RUSH]: ServiceTimeType.SELECT}),
            ),
        ]),
    ],
    ...
    [Service.R]: [
        new ServiceInformation(Service.R, "Broadway Local", [
            ...
            new ServicePattern(
                ...
                null,
                {},
                new ServiceTime({[ServiceTimeComponent.ALL_TIMES_EXCEPT_LATE_NIGHTS]: ServiceTimeType.YES}),
            ),

            // Short turn at Queens Plaza
            new ServicePattern(
                "Queens-bound trips 10 PM - Midnight",
                [...segmentsWithLabel(["QB8", "QB9"], TrackType.LOCAL, Line.IND_QUEENS_BOULEVARD_LINE)],
                [],
                null,
                {},
                new ServiceTime({[ServiceTimeComponent.LATE_EVENINGS]: ServiceTimeType.YES}),
                null,
            ),
            ...
            new ServicePattern(
                "Two northbound afternoon trips",
                [...segmentsWithLabel(["QB4", "QB5", "QB6L", "QB7", "QBAS1", "QBAS2", "QBAS3", "QB8", "QB9"], TrackType.LOCAL, Line.IND_QUEENS_BOULEVARD_LINE)],
                [],
                null,
                null,
                new ServiceTime({[ServiceTimeComponent.AFTERNOON_MIDDAYS]: ServiceTimeType.SELECT}),
                null,
            ),
    ...
    [Service.J]: [
        new ServiceInformation(Service.J, "Nassau Street Local", [
            new ServicePattern(
                "All times except rush hours and middays",
                [
                    ...
                    ...segmentsWithLabel(["NS1", "NS2"], TrackType.LOCAL, Line.BMT_NASSAU_STREET_LINE, ArrowDirection.RIGHT, {
                        [ServiceDirection.NORTH]: "Center",
                    }),
                ],
                [],
                {},
                ...
                new ServiceTime({
                    [ServiceTimeComponent.EARLY_MORNINGS]: ServiceTimeType.YES,
                    [ServiceTimeComponent.MORNINGS]: ServiceTimeType.YES,
                    [ServiceTimeComponent.EARLY_EVENINGS]: ServiceTimeType.YES,
                    [ServiceTimeComponent.LATE_NIGHTS]: ServiceTimeType.YES,
                }),
                new ServiceTime({
                    [ServiceTimeComponent.EARLY_MORNINGS]: ServiceTimeType.YES,
                    [ServiceTimeComponent.AFTERNOONS]: ServiceTimeType.YES,
                    [ServiceTimeComponent.EARLY_EVENINGS]: ServiceTimeType.YES,
                    [ServiceTimeComponent.LATE_NIGHTS]: ServiceTimeType.YES,
                }),
            ),
            new ServicePattern(
                "Weekday evenings, weekends all day",
                [
                    ...segmentsWithLabel(["AA1"], TrackType.LOCAL, Line.BMT_ARCHER_AVENUE_LINE),
                    ...segmentsWithLabel(["J1", "J2", "J3", "J4", "J5", "J6"], TrackType.LOCAL, Line.BMT_JAMAICA_LINE, ArrowDirection.RIGHT),
                    ...segmentsWithLabel(["NS1", "NS2"], TrackType.LOCAL, Line.BMT_NASSAU_STREET_LINE, ArrowDirection.RIGHT, {
                        [ServiceDirection.NORTH]: "South",
                    }),
                ],
                [],
                {},
            ...
            new ServicePattern(
                "Southbound weekday trips 6:30 AM - noon, northbound weekday trips 1 - 7:30 PM",
                [
                    ...segmentsWithLabel(["AA1"], TrackType.LOCAL, Line.BMT_ARCHER_AVENUE_LINE),
                ...
                {},
                null,
                new ServiceTime({[ServiceTimeComponent.AFTERNOON_MIDDAYS]: ServiceTimeType.YES}),
                new ServiceTime({[ServiceTimeComponent.MORNING_MIDDAYS]: ServiceTimeType.YES}),
            ),
            new ServicePattern(
                "Seven southbound weekday trips 7 - 9 AM, Five northbound weekday trips 5 - 6:30 PM",
                [
                    ...segmentsWithLabel(["AA1"], TrackType.LOCAL, Line.BMT_ARCHER_AVENUE_LINE),
                    ...segmentsWithLabel(["J1", "J2", "J3"], TrackType.LOCAL, Line.BMT_JAMAICA_LINE),
                    ...segmentsWithLabel(["J4", "J5"], TrackType.PEAK_DIRECTION_EXPRESS, Line.BMT_JAMAICA_LINE, ArrowDirection.RIGHT),
            ...
            new ServicePattern(
                "Three northbound weekday trips 6:30 - 7:30 AM",
                [
                    ...segmentsWithLabel(["AA1"], TrackType.LOCAL, Line.BMT_ARCHER_AVENUE_LINE),
                ...
                {},
                null,
                new ServiceTime({[ServiceTimeComponent.EARLY_MORNINGS]: ServiceTimeType.SELECT}),
                null,
            ),
            new ServicePattern(
                "Two northbound weekday trips 8:30 - 9 AM, Two southbound weeday trips 4:30 - 5 PM",
                [
        ...
        new ServiceInformation(Service.Z, "Nassau Street Express", [
            new ServicePattern(
                "Six southbound weekday trips 7 - 9 AM, six northbound weekday trips 5 - 6:30 PM",
                [
                    ...segmentsWithLabel(["AA1"], TrackType.LOCAL, Line.BMT_ARCHER_AVENUE_LINE),
                    ...segmentsWithLabel(["J1", "J2", "J3"], TrackType.LOCAL, Line.BMT_JAMAICA_LINE),
                    ...segmentsWithLabel(["J4", "J5"], TrackType.PEAK_DIRECTION_EXPRESS, Line.BMT_JAMAICA_LINE, ArrowDirection.RIGHT),
    ...
    [Service.M]: [
        new ServiceInformation(Service.M, "Queens Boulevard Local/Sixth Avenue Local", [
            ...
            new ServicePattern(
                "Weekdays 9 - 11:30 PM, Weekends 7 AM - 11:30 PM",
                [
...
const accumulateTrackServiceTime = (track, stops, arrowDirection, service, nextStop, lastStop, time) => {
    ...
    if (track.service[key] === undefined) {
        track.service[key] = new ServiceTimeStops(
            service,
            stops,
            arrowDirection,
            {
    ...
    for (const serviceInformation of SERVICES[parentService]) {
        ...
        for (const pattern of servicePatterns) {
            ...
            for (let i = 0; i < route.length; i++) {
                ...
                const leftServiceDisambiguator =
                    serviceDisambiguators[ServiceDirection.BOTH] ?? serviceDisambiguators[oppositeServiceDirection(rightDirection)];
                ...
                for (let j = 0; j < platformSets.length; j++) {
                    ...
                    if ((i === 0 && j === 0 && northTerminal !== null) || (i === route.length - 1 && j === platformSets.length - 1 && southTerminal !== null)) {
                        ...
                        const [terminal, terminalServiceDirection] =
                            i === 0 && j === 0 ? [northTerminal, ServiceDirection.SOUTH] : [southTerminal, ServiceDirection.NORTH];
                        ...
                        const terminationTracks =
                            Object.entries(terminal).length === 0 || ignoreTerminationTracks
                                ? []
                                : filteredTracks.filter(({track}) => terminal[track.terminalKey] === false);
                        ...
                        const activeTracks =
                            Object.entries(terminal).length === 0 ? filteredTracks : filteredTracks.filter(({track}) => terminal[track.terminalKey] === true);
                        [tracksNorth, tracksSouth] =
                            terminalServiceDirection === ServiceDirection.NORTH ? [activeTracks, terminationTracks] : [terminationTracks, activeTracks];
                    } else {
                        let tracksRight = [];
                        let tracksLeft = [];
                        for (const track of platformSet.tracks) {
                            ...
                            if (
                                ignoreArrowDirection !== ArrowDirection.RIGHT &&
                                (track.direction === ArrowDirection.RIGHT || track.direction === ArrowDirection.BOTH) &&
                                track.type === type &&
                                track.line === line &&
                                (track.disambiguator === null || track.disambiguator === rightServiceDisambiguator)
                            ) {
                            ...
                            if (
                                ignoreArrowDirection !== ArrowDirection.LEFT &&
                                (track.direction === ArrowDirection.LEFT || track.direction === ArrowDirection.BOTH) &&
                                track.type === type &&
                                track.line === line &&
                                (track.disambiguator === null || track.disambiguator === leftServiceDisambiguator)
                            ) {
                                if (track.trackDescription || !track.showTrack) {
                                    throw new Error("Track with description or hidden track has service");
                                }
                        ...
                        if (
                            (tracksRight.length === 0 && ignoreArrowDirection !== ArrowDirection.RIGHT) ||
                            (tracksLeft.length === 0 && ignoreArrowDirection !== ArrowDirection.LEFT)
                        ) {
            ...
            for (let i = 0; i < compiledRoute.length; i++) {
                ...
                const nextStopNorth = compiledRoute
                    .toReversed()
                    .find(
                        (el, index) => (el.tracksNorth.some(({stops}) => stops) || index === compiledRoute.length - 1) && index >= compiledRoute.length - i,
                    ) ?? {stop: "", disambiguator: null};
                const nextStopSouth = compiledRoute.find(
                    (el, index) => (el.tracksSouth.some(({stops}) => stops) || index === compiledRoute.length - 1) && index > i,
                ) ?? {stop: "", disambiguator: null};
                ...
                for (const {track, stops} of tracksSouth) {
                    accumulateTrackServiceTime(
                        track,
                        stops,
                        northDirection === ArrowDirection.RIGHT ? ArrowDirection.LEFT : ArrowDirection.RIGHT,
                        service,
                        nextStopSouth,
                        lastStopSouth,
                        southServiceTime,
...
for (const platformSet of Object.values(PLATFORM_SETS)) {
    for (const track of platformSet.tracks) {
        ...
        for (const service of Object.keys(track.service)) {
            track.service[service].serviceTime = accumulateServiceTime(
                Object.values(track.service[service].nextStopService).map((stopService) => stopService.time),
            );
...
const MIN_BOARDINGS = Math.min(
    ...Object.values(STATIONS)
        .filter(({boardings}) => typeof boardings === "number")
        .map(({boardings}) => boardings),
);
