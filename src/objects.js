...
const SERVICE_TIMES_ENTRIES = [
	...
	new ServiceTimeTreeEntry(ServiceTimeComponent.ALL_TIMES_EXCEPT_AM_RUSH, [ServiceTimeComponent.LATE_NIGHTS, ServiceTimeComponent.WEEKENDS, ServiceTimeComponent.EARLY_MORNINGS, ServiceTimeComponent.MIDDAYS, ServiceTimeComponent.PM_RUSH, ServiceTimeComponent.EVENINGS]),
	new ServiceTimeTreeEntry(ServiceTimeComponent.ALL_TIMES_EXCEPT_PM_RUSH, [ServiceTimeComponent.LATE_NIGHTS, ServiceTimeComponent.WEEKENDS, ServiceTimeComponent.EARLY_MORNINGS, ServiceTimeComponent.AM_RUSH, ServiceTimeComponent.MIDDAYS, ServiceTimeComponent.EVENINGS]),
	new ServiceTimeTreeEntry(ServiceTimeComponent.ALL_TIMES_EXCEPT_MORNINGS, [ServiceTimeComponent.LATE_NIGHTS, ServiceTimeComponent.WEEKENDS, ServiceTimeComponent.EARLY_MORNINGS, ServiceTimeComponent.AFTERNOON_MIDDAYS, ServiceTimeComponent.PM_RUSH, ServiceTimeComponent.EVENINGS]),
	new ServiceTimeTreeEntry(ServiceTimeComponent.ALL_TIMES_EXCEPT_AFTERNOONS, [ServiceTimeComponent.LATE_NIGHTS, ServiceTimeComponent.WEEKENDS, ServiceTimeComponent.EARLY_MORNINGS, ServiceTimeComponent.AM_RUSH, ServiceTimeComponent.MORNING_MIDDAYS, ServiceTimeComponent.EVENINGS]),
	new ServiceTimeTreeEntry(ServiceTimeComponent.ALL_TIMES_EXCEPT_AM_RUSH_AND_LATE_NIGHTS, [ServiceTimeComponent.WEEKENDS, ServiceTimeComponent.EARLY_MORNINGS, ServiceTimeComponent.MIDDAYS, ServiceTimeComponent.PM_RUSH, ServiceTimeComponent.EVENINGS]),
	new ServiceTimeTreeEntry(ServiceTimeComponent.ALL_TIMES_EXCEPT_PM_RUSH_AND_LATE_NIGHTS, [ServiceTimeComponent.WEEKENDS, ServiceTimeComponent.EARLY_MORNINGS, ServiceTimeComponent.AM_RUSH, ServiceTimeComponent.MIDDAYS, ServiceTimeComponent.EVENINGS]),
	new ServiceTimeTreeEntry(ServiceTimeComponent.LATE_NIGHTS, []),
	new ServiceTimeTreeEntry(ServiceTimeComponent.WEEKENDS, []),
	new ServiceTimeTreeEntry(ServiceTimeComponent.WEEKDAYS, [ServiceTimeComponent.EARLY_MORNINGS, ServiceTimeComponent.RUSH_HOURS, ServiceTimeComponent.MIDDAYS, ServiceTimeComponent.EVENINGS]),
	...
	new ServiceTimeTreeEntry(ServiceTimeComponent.WEEKDAYS_SP, [ServiceTimeComponent.RUSH_HOURS, ServiceTimeComponent.MIDDAYS, ServiceTimeComponent.EVENINGS], ServiceTimeComponent.WEEKDAYS),
	new ServiceTimeTreeEntry(ServiceTimeComponent.WEEKDAYS_EXCEPT_AM_RUSH, [ServiceTimeComponent.EARLY_MORNINGS, ServiceTimeComponent.MIDDAYS, ServiceTimeComponent.PM_RUSH, ServiceTimeComponent.EVENINGS]),
	new ServiceTimeTreeEntry(ServiceTimeComponent.WEEKDAYS_EXCEPT_PM_RUSH, [ServiceTimeComponent.EARLY_MORNINGS, ServiceTimeComponent.AM_RUSH, ServiceTimeComponent.MIDDAYS, ServiceTimeComponent.EVENINGS]),
	new ServiceTimeTreeEntry(ServiceTimeComponent.WEEKDAYS_EXCEPT_LATE_EVENINGS, [ServiceTimeComponent.EARLY_MORNINGS, ServiceTimeComponent.RUSH_HOURS, ServiceTimeComponent.MIDDAYS, ServiceTimeComponent.EARLY_EVENINGS]),
...
function ServiceTimeInternal(leaves){
	...
	this.getShorthand = (type=null) => {
		...
		this._shorthand = {
			...getShorthandForType(this._leaves.map(value => value === ServiceTimeType.YES), ServiceTimeType.YES),
			...getShorthandForType(this._leaves.map(value => value === ServiceTimeType.SELECT), ServiceTimeType.SELECT),
		};
		return filterFunction(this._shorthand);
	};
...
const accumulateServiceTime = (patterns) => patterns.reduce((base, next) => 
	(next === null ? base : new ServiceTimeInternal(base.getLeaves().map((value, index) => Math.max(value, next.getLeaves()[index])))), 
