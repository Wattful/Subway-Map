...
import {Line, StructureType, Division, SignalingType, Company} from "./enums.js";
    ...
    for (const segmentNodes of segmentNodesLists) {
        ...
        for (let i = 0; i < segmentNodes.length; i++) {
            ...
            segments.forEach((segment) => {
                Object.assign(trackData[segment], attrs);
            });
...
function assignAttributesToLine(line, attrs) {
    Object.values(trackData)
        .filter((segment) => segment.lines?.includes(line))
        .forEach((segment) => {
...
assignAttributes(
    [
        [queensBlvdN, queensBlvdArcherAv, queensBlvdNSplitS],
        [queensBlvdLocalSplitN, queensBlvdLocalSplitS],
        [queensBlvdExpressSplitN, queensBlvdExpressSplitS],
        [queensBlvdSSplitN, queensBlvdAstoriaN],
        [queensBlvdAstoriaS, queensBlvdBroadway, queensBlvdCrosstown, queensBlvdSixthAvE, queensBlvdSixthAvW],
        [queensBlvdEighthAv, queensBlvdS],
    ],
    {lines: [Line.IND_QUEENS_BOULEVARD_LINE]},
);
...
assignAttributes(
    [
        [queensBlvdArcherAv, queensBlvdNSplitS],
        [queensBlvdSSplitN, queensBlvdAstoriaN],
        [queensBlvdAstoriaS, queensBlvdBroadway, queensBlvdCrosstown],
    ],
    {total_tracks: 4, used_tracks: 4, unused_tracks: 0},
);
...
assignAttributes(
    [
        [sixthNBranchN, sixthNBranchS],
        [sixthQBLJunctionEastN, sixthQBLJunctionEastS],
        [sixthQBLJunctionWestN, sixthQBLJunctionWestS],
        [sixthMainBranchN, sixthEighthN],
        [sixthEighthS, sixthMainBranchS],
        [sixthMBranchN, sixthMBranchS],
    ],
    {lines: [Line.IND_SIXTH_AVENUE_LINE]},
);
...
assignAttributes(
    [
        [sixthQBLJunctionEastN, sixthQBLJunctionEastS],
        [sixthQBLJunctionWestN, sixthQBLJunctionWestS],
        [sixthMainBranchN, sixthEighthN, sixthEighthS, sixthMainBranchS],
    ],
    {obf: Company.IND},
);
assignAttributes(
    [
        ...
        [sixthQBLJunctionWestN, sixthQBLJunctionWestS],
        [sixthMainBranchN, sixthEighthN],
        [sixthEighthS, sixthBwayLfyetN],
    ],
    {opened: DateTime.fromObject({year: 1940, month: 12, day: 15})},
);
...
assignAttributes(
    [
        [ind63QueensbridgeN, ind63Bmt63N, ind63Bmt63S],
        [ind63SN, ind63SS],
    ],
    {
...
const serviceSegmentBorders = Object.entries(
    Object.values(trackData).reduce((acc, segment) => {
