...
const BULLETS = {
	[Service.B]: () => <CircleBullet color="#FF6319"><path d="M85.5,72.1c0-3.2-0.933-5.967-2.8-8.3c-2.067-2.533-4.8-3.967-8.2-4.3l0.2,0.2l-0.1,0.2c5.733-1.133,8.6-4.567,8.6-10.3c0-4.067-1.467-7.233-4.4-9.5c-2.667-2.133-6.2-3.2-10.6-3.2H44.5v50.4H66c6.067,0,10.633-0.933,13.7-2.8C83.567,82.033,85.5,77.9,85.5,72.1zM72.9,50.8c0,4.067-2.533,6.1-7.6,6.1H54.4V44.8h10.9C70.367,44.8,72.9,46.8,72.9,50.8z M75.2,71.8c0,4.467-2.967,6.7-8.9,6.7H54.4V64.4h11.9C72.233,64.4,75.2,66.867,75.2,71.8z" fill="#FFF"/></CircleBullet>,
	[Service.D]: () => <CircleBullet color="#FF6319"><path d="M86.8,62.1c0-7.6-1.933-13.6-5.8-18c-4.267-4.8-10.567-7.2-18.9-7.2H44.4v50.4h19.4C79.133,87.3,86.8,78.9,86.8,62.1zM76.5,62.1c0,6.067-1.2,10.333-3.6,12.8c-2.133,2.133-5.6,3.2-10.4,3.2h-8.3v-32h8.1C71.767,46.1,76.5,51.433,76.5,62.1z" fill="#FFF"/></CircleBullet>,
	...
	[Service.J]: () => <CircleBullet color="#996633"><path d="M 77 71.1 V 37 h -9.8 v 34.5 c 0 3.133 -0.45 5.3 -1.35 6.5 s -2.617 1.8 -5.15 1.8 c -2.4 0 -4.05 -0.55 -4.95 -1.65 s -1.35 -3.083 -1.35 -5.95 v -3 h -9.8 v 3.1 c 0 4.933 1.2 8.8 3.6 11.6 c 2.667 3.2 6.6 4.8 11.8 4.8 c 6.667 0 11.367 -1.833 14.1 -5.5 C 76.033 80.467 77 76.433 77 71.1 Z" fill="#FFF"/></CircleBullet>,
	[Service.Z]: () => <CircleBullet color="#996633"><polygon points="81.6,87.3 81.7,78.5 55.1,78.5 81.7,45.5 81.7,36.9 44.6,36.9 44.6,45.7 68.9,45.7 42.3,78.7 42.3,87.3" fill="#FFF"/></CircleBullet>,
}
